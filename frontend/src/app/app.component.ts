...
@Component({
  ...
  styles: [`
    ...
    .raw-extract { margin: 0; padding: 10px 12px; border: 1px dashed #c5d3e3; border-radius: 6px; background: #f8fbff; color: #4b5f77; font-size: 12px; }
    .raw-extract summary { cursor: pointer; font-weight: 600; }
    .raw-extract pre { margin: 8px 0 0; white-space: pre-wrap; word-break: break-word; max-height: 220px; overflow: auto; font-size: 11px; color: #304158; }
...
approve() {
  ...
  rawExtractedText(): string { const trace = this.trace(); return String(trace.isolatedCaseText || trace.rawExtractedText || '').trim(); }
